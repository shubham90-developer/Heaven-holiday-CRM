...
const B2BOfflineTicketModal:React.FC = () =>{
      const [show,setShow]=useState<boolean>(false);
         const [type, setType] = useState("oneway");
          const [tourtype, settourType] = useState("agency");
                    ...
                    <Form>
                        <Row className="mb-1 align-items-center">
                          ...
                          <Col md={6}>
                            ...
                            type="radio"
                            label="Agency"
                            checked={tourtype==="agency"}
                            onChange={()=>settourType("agency")}
                            style={{fontSize:"10px"}}
                            className="text-primary"
                            />
                            ...
                            <Form.Check
                                                type="radio"
                                                label="Corporate"
                                                checked={tourtype === "corporate"}
                                                onChange={() => settourType("corporate")}
                                                style={{ fontSize: "10px" }}
                                                className="text-primary"
                                              />
                                              </div>
...
export default B2BOfflineTicketModal;