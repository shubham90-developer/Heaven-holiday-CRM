    ...
    <>
      <Card className="p-3 ">
        <div className="pb-2 border-bottom text-end">
            ...
            style={{fontSize: "10px"}}><Icon icon="mdi:arrow-left" className='me-1'/> My Invoice List</Button>
        </div>
        <div className="p-3">
            <Form>
                <Row>
        ...
        <Col md={2}>
            <Form.Label className="text-primary" style={{fontSize: "10px"}}>Invoice Date *</Form.Label>
        ...
        <Col md={3}>
            <Form.Label className="text-primary" style={{fontSize: "10px"}}>Invoice Number *</Form.Label>
        ...
        <Col md={3}>
            <Form.Label className="text-primary" style={{fontSize: "10px"}}>Sales By *</Form.Label>
            <Form.Select size="sm"  style={{fontSize: "10px"}}>
       ...
       {[...Array(addItem)].map((_, index) =>(
        ...
        <Form.Control type="number" placeholder='0.00' size="sm"  style={{fontSize: "10px", maxWidth: "150px"}} /> 
               </div>
        ...
        <Form.Control type="number" placeholder='0.00'readOnly size="sm"  style={{fontSize: "10px", maxWidth: "150px"}} /> 
                ...
                <div className='d-flex gap-2 justify-content-end border-bottom p-2' >
                    <div style={{fontSize: "12px"}}>TCS</div>
        <Form.Control type="number" placeholder='0.00'readOnly size="sm"  style={{fontSize: "10px", maxWidth: "150px"}} /> 
               </div>
                <div className='d-flex gap-2 justify-content-end border-bottom p-2' >
        ...
        <Form.Control type="number" placeholder='0.00'readOnly size="sm"  style={{fontSize: "10px", maxWidth: "150px"}} /> 
              ...
              <div className='border-bottom p-2'style={{fontSize: "12px"}} >
                 ...
                 <div className='d-flex gap-2'>
                    <Form.Check type="checkbox" label="Allow Partial Payment" className='me-5' style={{fontSize: "12px"}}  />
                   <Form.Check type="checkbox" label="Display Markup" className='me-5' style={{fontSize: "12px"}}  />
                </div>
                   <Button variant="outline-danger" size="sm" 
                   
                   style={{fontSize: "12px"}} onClick={()=>setViewInvoice(true)}>Preview</Button>
            ...
            { viewinvoice && ( <ViewInvoiceModal onClose={() => setViewInvoice(false)} /> ) }
      </Card>
    </>
  )
}
